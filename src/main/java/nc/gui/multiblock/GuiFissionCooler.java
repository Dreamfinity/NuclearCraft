...
public class GuiFissionCooler extends GuiProcessorImpl.GuiBasicFilteredProcessor<TileFissionCooler, FissionCoolerUpdatePacket> {
	
	public GuiFissionCooler(Container inventory, EntityPlayer player, TileFissionCooler tile, String textureLocation) {
