...
public class BlockPlasmaFire extends BlockFire {
    ...
    public void updateTick(World world, int x, int y, int z, Random rand) {
        if (world.getGameRules().getGameRuleBooleanValue("doFireTick")) {
            ...
            if (world.isRaining() && (world.isRainingAt(x, y, z) || world.isRainingAt(x - 1, y, z) || world.isRainingAt(x + 1, y, z) || world.isRainingAt(x, y, z - 1) || world.isRainingAt(x, y, z + 1))) {
                        ...
                        for (int k1 = y - 1; k1 <= y + 4; ++k1) {
                            if (i1 != x || k1 != y || j1 != z) {
                                ...
                                if (i2 > 0) {
                                    ...
                                    if (j2 > 0 && rand.nextInt(l1) <= j2 && (!world.isRaining() || !world.isRainingAt(i1, k1, j1)) && !world.isRainingAt(i1 - 1, k1, z) && !world.isRainingAt(i1 + 1, k1, j1) && !world.isRainingAt(i1, k1, j1 - 1) && !world.isRainingAt(i1, k1, j1 + 1)) {
    ...
    public void onBlockAdded(World world, int x, int y, int z) {
        if (world.provider.dimensionId > 0 || !Blocks.portal.tryToCreatePortal(world, x, y, z)) {
