...
public class EntityAntimatterBombPrimed extends Entity {
    ...
    public void onUpdate() {
        if (!NuclearCraft.enableAntiMatterExplosion) {
            ...
            if (this.tntPlacedBy instanceof EntityPlayer) {
                ((EntityPlayer) tntPlacedBy).addChatMessage(new ChatComponentTranslation("message.nuclearcraft.antimatterExplosionDisabled"));
            }
            this.setDead();
            return;
        }
